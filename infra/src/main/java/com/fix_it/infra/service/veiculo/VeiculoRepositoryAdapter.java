...
import com.fix_it.infra.persistence.repository.SpringDataVeiculoRepository;
...
public class VeiculoRepositoryAdapter implements com.fix_it.usecase.port.VeiculoRepository {
    ...
    private final SpringDataVeiculoRepository springRepository;
    private final VeiculoMapper mapper;

    public VeiculoRepositoryAdapter(SpringDataVeiculoRepository springRepository, VeiculoMapper mapper) {
