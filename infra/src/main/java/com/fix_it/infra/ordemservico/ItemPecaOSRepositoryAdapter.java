...
import com.fix_it.persistence.repository.ItemPecaOSRepository;
...
public class ItemPecaOSRepositoryAdapter implements com.fix_it.usecase.port.ItemPecaOSRepository {
    ...
    private final ItemPecaOSRepository springRepository;
    private final ItemPecaOSMapper mapper;

    public ItemPecaOSRepositoryAdapter(ItemPecaOSRepository springRepository, ItemPecaOSMapper mapper) {
